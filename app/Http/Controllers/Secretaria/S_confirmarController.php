...
class S_confirmarController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $habitacion = DB::table('habitacion') //Aqui se consultan los datos de la habitación
                    ...
                    ->get();
        return view('secretaria.confirmar_datos')->with('habitacion', $habitacion); //retorna los datos de la habitación
    ...
    public function edit($id)
    {
        ...
        return view('secretaria.confirmarHabitacion')->with('habitacion', $habitacion); //reotrna la vista de edición de habitación
    }
    ...
    public function update(Request $request, $id) //esta función recibe datos de edición y la id de la habitación que se desea editar
    {
      ...
      return redirect()->route('s_confirmar_datos'); //redirije a la ruta lista_habitaciones
    }
    ...
    public function show($id)
    {
        ...
        return redirect()->route('s_confirmar_datos');
    }
