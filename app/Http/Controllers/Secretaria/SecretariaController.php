...
class SecretariaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('secretaria.listado_hotel')->with('hoteles', $hoteles);
    }
    ...
    {
      $hoteles = hotel::find($id); //Busca la id recibida en la tabla habitacion
      $hoteles-> nombre_hotel = $request->nombre_hotel; //En las siguientes lineas remplaza los datos a modificar en la base de datos
      $hoteles-> id_ciudad = $request->id_ciudad;
      $hoteles->save(); //Guarda los datos modificados en la base de datos
      return redirect()->route('s_listado_hotel'); //redirije a la ruta lista_habitaciones
    }

    /*public function edit($id)
    {
        $hoteles = hotel::find($id);
        return view('secretaria.editarHotel')->with('hoteles', $hoteles); 
    }*/

    public function show($id) //busca la id recibida en la base de datos
    {
        $hoteles = hotel::find($id);//busca la id recibida en la base de datos
        return view('secretaria.editarHotel')->with('hoteles', $hoteles); //reotrna la vista de edición de hotel
    }
     ...
     public function destroy($id)
    {
        ...
        $hotel->delete();
        return redirect()->route('s_listado_hotel');
    }


    /*Habitaciones para dejarlo en un solo controlador es el S_habitacionController
