                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form class="form-group" method="POST" action="/d_agregado_habitacion">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nombre_hotel" class="form-control" value="{{ Auth::user()->name }}" readonly="readonly" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
