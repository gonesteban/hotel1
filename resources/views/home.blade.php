...
<div class="wrapper">
    ...
    <div class="main-panel">
        <nav class="navbar navbar-default navbar-fixed">
          ...
          <div class="content text-center" style="background-image: url('/pagina/img/vaciones-de-lujo-InterContinental.jpg'); width: 100%; height: 100%; "> <!-- Aca se rellena para que muestre los hoteles -->
            <FONT SIZE=20 color='white' FACE="Old English Text MT">Bienvenido {{ Auth::user()->name }}</FONT>
        </div>
