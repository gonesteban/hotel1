    ...
    <!--   you can change the color of the sidebar using: data-color="blue | azure | green | orange | red | purple" -->
        ...
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                 <li class="active">
                    <a href="home">
                        <i class="pe-7s-search"></i> <!-- las opciones uqe muestra en la barra lateral-->
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Hoteles Disponibles</h4> <!--Mostramos todo los hoteles disponibles para ser reservados-->
                            </div>
                            <div class="content">
                              <form>
                                  <div class="content table-responsive table-full-width">
                                      ...
                                      <tbody>
                                      @foreach($hoteles as $hotel) <!--recorre todos los registros encontrados y los muestra en la vista-->
                                      <tr>

                                      <td>{{$hotel->nombre_hotel}}</td>
                                      <td>{{$hotel->nombre_ciudad}}</td>
                                      <!--<td> <a href="reserva" class="btns green">Reservar Habitación</a>  </td>-->
